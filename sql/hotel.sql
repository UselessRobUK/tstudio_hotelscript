...
CREATE INDEX idx_hotel_rentals_identifier ON hotel_rentals(identifier);
CREATE INDEX idx_hotel_rentals_hotel_room ON hotel_rentals(hotel, room);
CREATE INDEX idx_hotel_bookings_hotel_room ON hotel_bookings(hotel, room);
CREATE INDEX idx_hotel_complaints_hotel ON hotel_complaints(hotel);
